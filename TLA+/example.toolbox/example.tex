...
\fl{}\moduleLeftDash\cl{ {\MODULE} example}\moduleRightDash\cl{}
\fl{}
\fl{ {\EXTENDS} Integers ,\, TLC}
\fl{}
\fl{ {\p@mmalgorithm} example}
\fl{}
\fl{ {\p@variables} x \.{\in} 1 \.{\dotdot} 5}
\fl{}
\fl{ {\p@begin}}
...
\fl{ {\VARIABLES} x ,\, pc}
\fl{}
\fl{ vars}\al{16}{1}{ \.{\defeq} {\langle} x ,\, pc {\rangle}}
\fl{}
\fl{ Init}\al{18}{1}{ \.{\defeq}}\al{18}{2}{%
\@y{\@s{0}%
 Global variables
}%
}
\fl{ \.{\land}}\al{19}{1}{ x \.{\in} 1 \.{\dotdot} 5}
\fl{ \.{\land}}\al{20}{1}{ pc \.{=}\@w{Add}}
\fl{}
 \fl{ Add \.{\defeq}}\al{22}{2}{ \.{\land}}\al{22}{3}{ pc}\al{22}{4}{
 \.{=}}\al{22}{5}{\@w{Add}}
\fl{ \.{\land}}\al{23}{1}{ x \.{'}}\al{23}{3}{ \.{=}}\al{23}{4}{ x \.{+} 1}
\fl{ \.{\land}}\al{24}{1}{ pc \.{'} \.{=}\@w{Done}}
\fl{}
\fl{ Next}\al{26}{1}{ \.{\defeq}}\al{26}{2}{ Add}
\fl{ \.{\lor}}\al{27}{1}{%
\@y{\@s{0}%
